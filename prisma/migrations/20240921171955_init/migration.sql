...
-- CreateEnum
CREATE TYPE "Color" AS ENUM ('BLACK', 'WHITE', 'GREY', 'YELLOW', 'ORANGE', 'RED', 'GREEN', 'BLUE', 'CIAN', 'PINK', 'PURPLE');
...
CREATE TABLE "Product" (
    ...
    "price_cop" DECIMAL(65,30) NOT NULL,
    "price_bs" DECIMAL(65,30) NOT NULL,
